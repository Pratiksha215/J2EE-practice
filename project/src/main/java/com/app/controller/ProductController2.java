...
public class ProductController2 {
	...
	public String showAddProductForm(Model map)
	{
		...
		//Simply add Product pojo transient instance as a model attribute(in Model map)
	       map.addAttribute("new_product",new Product());//1st step in form binding
		return "/product/add";//Vr:/WEB-INF/views/product/add.jsp
	}
	// add req handling method to process the form
		@PostMapping("/add")
		public String processAddProductForm(@ModelAttribute(name = "new_product")Product transientPopulatedProduct,
