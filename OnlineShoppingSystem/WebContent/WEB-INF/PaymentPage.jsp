...
<!------ Include the above in your HEAD tag ---------->
   ...
   <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card card-outline-secondary">
                        <div class="card-body">
                            <h3 class="text-center">Payment Summary Page</h3>
                            <hr>
                            <div class="alert alert-info p-2 pb-3">
                                <a class="close font-weight-normal initialism" data-dismiss="alert" href="#"><samp>×</samp></a> 
                                CVC code is required.
                            </div>
                            <form class="form" role="form" autocomplete="off" action="/ClearCart" method="POST">
                                ...
                                <div class="form-inline">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control text-right" id="exampleInputAmount" placeholder="${total }" disabled>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <a href="/MyCart" class="btn btn-default btn-lg btn-block">Cancel</a>
                                    </div>
                                    <div class="col-md-6">
