...
<head>
    ...
    <title>Complaint Verification Portal</title>
...
<ul>
   ...
   <li><a href="/AdminLogin"  class='active'>Admin Portal</a></li>
</ul>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="post" id="signup-form" class="signup-form" action ='/adminlogin' onsubmit="return validate()">
                        <div class = "form-group" align = 'center'><h3>Admin   Login</h3></div>
